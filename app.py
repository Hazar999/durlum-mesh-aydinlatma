...
st.caption("Kaynak veri: durlum RHOMBOS Expanded Metal Ceilings kataloğu. Bu sürüm, ücretsiz GPT aktarım köprüsü içeren V7 prototipidir; ön değerlendirme ve alternatif sıralaması içindir.")
